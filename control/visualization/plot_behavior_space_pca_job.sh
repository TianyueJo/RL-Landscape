...
#SBATCH --output=slurm_logs/behavior_pca_%j.out
#SBATCH --error=slurm_logs/behavior_pca_%j.err
...
echo "=========================================="
echo "[Behavior Space PCA] Starting job"
echo "Time: $(date)"
echo "Node: $(hostname)"
...
# Run the behavior space PCA script
