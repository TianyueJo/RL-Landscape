#!/bin/bash
#SBATCH --job-name=jr_25_31_arr
#SBATCH --partition=cpu-gpu-v100
#SBATCH --output=slurm_logs/jr_25_31_arr_%A_%a.out
#SBATCH --error=slurm_logs/jr_25_31_arr_%A_%a.err
...
JR_INDEX=$ARRAY_ID
RNG_SEED=$(( 20000 + JR_INDEX ))  # use a different base to avoid collisions with 22_27
...
MODELS_DIR="models/jump_retrain_25_31"
OUTPUT_ROOT="results/jump_retrain_25_31"
